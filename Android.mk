...
ifneq ($(BOARD_RECOVERY_RELEASE_TYPE),)
  ...
  RECOVERY_RELEASE_TYPE := Alpha
endif

RECOVERY_VERSION := $(RECOVERY_NAME) v2.2 $(BOARD_RECOVERY_RELEASE_TYPE)
...
BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY RECOVERY_EXTEND_NANDROID_MENU TARGET_USE_CUSTOM_LUN_FILE_PATH TARGET_RECOVERY_FSTAB
